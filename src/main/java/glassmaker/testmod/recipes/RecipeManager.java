...
public class RecipeManager {
	...
	public static void register(){
		...
		addShapedRecipe(new ResourceLocation("testmod:test_shaped_recipe"),"",pattern,keyMap, new ItemStack(TestMod.block));
	...
	private static void addShapedRecipe(ResourceLocation Identifier, String group, String[] pattern, Map<String, Ingredient> ingredientKeyMap, ItemStack output){
	...
	private static NonNullList<Ingredient> buildIngredientPattern(String[] pattern, Map<String, Ingredient> ingredientKeyMap, int patternWidth, int patternHeight) {
		NonNullList<Ingredient> ingredientPattern = NonNullList.<Ingredient>withSize(patternWidth * patternHeight, Ingredient.field_193370_a);
